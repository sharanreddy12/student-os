...
function Sidebar() {
  const items = [
    { icon: Home, label: "Home", active: true, to: "/dashboard" },
...
function TopBar({ onCmd }: { onCmd: () => void }) {
  return (
    <div className="mb-8 flex items-center gap-3">
      ...
      <button className="glass grid h-10 w-10 place-items-center">
  ...
  return (
    <div className="mb-8">
      ...
      <p className="mt-2 text-muted-foreground">
        You're on a 27-day streak. 2 assignments due this week.
      </p>
    </div>
  );
}
    ...
    <div className="grid grid-cols-12 gap-4 auto-rows-[minmax(150px,auto)]">
        ...
        <div className="space-y-2">
          {[
            ...
            >
              ...
              {r.active && (
                <span className="h-2 w-2 rounded-full bg-[color:var(--neon-cyan)] shadow-[0_0_10px_var(--neon-cyan)]" />
              )}
            </motion.div>
          ))}
        </div>
      ...
      <Card cls="col-span-12 md:col-span-4">
        ...
        <div className="text-5xl font-semibold">
          82<span className="text-2xl text-muted-foreground">%</span>
        </div>
        <div className="mt-2 h-1.5 rounded-full bg-white/10">
          <motion.div
            ...
            style={{ background: "linear-gradient(to right, var(--neon-green), var(--neon-cyan))" }}
          />
        </div>
      </Card>
      ...
      <Card cls="col-span-12 md:col-span-8">
        ...
        <div className="grid gap-2 md:grid-cols-2">
          {[
            ...
            <div
              key={n}
              className="rounded-xl bg-white/[0.03] px-4 py-3 text-sm hover:bg-white/[0.06] transition-colors cursor-pointer"
            >
      ...
      <Card cls="col-span-12 md:col-span-4" accent>
        ...
        <div className="text-sm text-foreground/90">
          Review Kinematics before tomorrow's lecture.
        </div>
        <button
          className="mt-4 flex items-center gap-2 rounded-full px-4 py-2 text-xs font-medium text-white"
          style={{ background: "var(--gradient-brand)" }}
        >
    ...
    <motion.div
      ...
      style={
        accent
          ? {
              background:
                "linear-gradient(140deg, color-mix(in oklab, var(--neon-purple) 20%, transparent), color-mix(in oklab, var(--neon-blue) 12%, transparent))",
            }
          : undefined
      }
    >
  ...
  function send() {
    ...
    setTimeout(() => {
      setMsgs((m) => [
        ...
        {
          from: "ai",
          text: "On it. Pulling Ch. 4, Lecture 09/12, and past-paper Q3 — ready in your Notes.",
        },
      ]);
    }, 700);
  }
        ...
        {msgs.map((m, i) => (
          ...
          >
            <div
              ...
              style={
                m.from === "ai"
                  ? { background: "color-mix(in oklab, var(--neon-purple) 18%, transparent)" }
                  : undefined
              }
            >
              {m.text}
