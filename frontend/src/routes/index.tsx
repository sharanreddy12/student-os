  ...
  return (
    <section className="relative pt-40 pb-24">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        >
          Your AI operating system for academic success. One intelligent surface for notes, classes,
...
function AICore() {
  ...
  const messages = [
    ...
    {
      from: "ai",
      text: "You have Physics tomorrow — I noticed 3 concepts from Chapter 4 aren't in your notes yet.",
    },
      ...
      <div className="mx-auto max-w-6xl px-6 grid gap-16 lg:grid-cols-2 items-center">
        <div>
          ...
          <p className="mt-6 max-w-lg text-muted-foreground">
            Not a chatbot bolted on. StudentOS understands your timetable, notes, deadlines, and
            progress — and quietly plans your next move.
          </p>
        </div>
        <div className="relative">
          <Panel3D intensity={6}>
            <div className="relative">
              <div
                className="absolute -inset-8 rounded-[3rem] blur-3xl opacity-70"
                style={{
                  background:
                    "radial-gradient(circle, color-mix(in oklab, var(--neon-purple) 40%, transparent), transparent 70%)",
                }}
              />
                      ...
                      <div
                        ...
                        style={
                          m.from === "ai"
                            ? {
                                background:
                                  "color-mix(in oklab, var(--neon-purple) 18%, transparent)",
                              }
                            : undefined
                        }
                      >
                  ...
                  {step < messages.length && (
                    <div className="flex gap-1.5 pl-2">
                      {[0, 1, 2].map((i) => (
                        <motion.span
                          key={i}
                          className="h-1.5 w-1.5 rounded-full bg-[color:var(--neon-purple)]"
    ...
    <div className="grid grid-cols-6 gap-3 min-h-[520px]">
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: on
                    ? "0 0 20px color-mix(in oklab, var(--neon-blue) 40%, transparent)"
                    : undefined,
                }}
              />
            );
      ...
      <Cell className="col-span-3" title="Resources" icon={BookOpen}>
        <div className="grid grid-cols-3 gap-2 text-[10px]">
          {["Physics.pdf", "Slides 04", "Past Papers", "MIT OCW", "Video 12", "Lab Manual"].map(
            (r) => (
              <div key={r} className="rounded-md bg-white/5 px-2 py-2 text-foreground/80">
                {r}
              </div>
            ),
          )}
    ...
    <section className="relative py-40">
      <div className="mx-auto max-w-6xl px-6 grid gap-16 lg:grid-cols-2 items-center">
            ...
            <div className="glass-strong shadow-elevate p-5">
              ...
              <div className="space-y-3 text-sm">
                ...
                <p className="text-foreground/80">
                  For constant acceleration, four kinematic equations relate displacement, velocity,
                ...
                >
                  ...
                  Three key equations describe motion under constant acceleration. Practice deriving
                  v² = u² + 2as from the other two.
                </div>
              </div>
            </div>
          </Panel3D>
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="mt-6 max-w-lg text-muted-foreground">
            Markdown, math, code, images — all in one calm editor. Summarize a chapter, generate a
            quiz, or ask a question without leaving the page.
          </p>
...
function Chip({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-white/8 px-2 py-1 text-[10px] text-foreground/85">
      {children}
    </span>
  );
}
    ...
    <div className="relative h-[440px]">
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: "0 0 80px color-mix(in oklab, var(--neon-purple) 60%, transparent)",
        }}
      >
      ...
      >
        ...
        Projectile motion decomposes into horizontal (constant v) and vertical (g) components. In
        lab 02, your 30° launch matched theory within 4%.
        <div className="mt-2 flex flex-wrap gap-1 text-[10px] text-muted-foreground">
          <span>· Ch.4</span>
          <span>· Lab 02</span>
          <span>· Lecture 09/12</span>
        </div>
      </motion.div>
    </div>
  );
    ...
    <section id="analytics" className="relative py-40">
      <div className="mx-auto max-w-6xl px-6 grid gap-16 lg:grid-cols-2 items-center">
        <div>
          ...
          <h2 className="mt-5 text-5xl md:text-6xl font-semibold tracking-tight">
            Every subject <br />
            <span className="text-gradient">measured, honestly.</span>
          </h2>
          <p className="mt-6 max-w-lg text-muted-foreground">
            Attendance rings, assignment velocity, study streaks, subjects trending down — surfaced
            early, never nagging.
          </p>
        </div>
        <Panel3D intensity={5}>
      ...
      <div className="mx-auto mt-16 max-w-6xl px-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {stages.map((s, i) => {
          ...
          return (
            ...
            >
              <div
                className="mx-auto grid h-10 w-10 place-items-center rounded-xl mb-3"
  ...
  return (
    <section className="relative py-48 text-center">
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div
          className="h-[420px] w-[420px] rounded-full animate-pulse-glow"
          style={{
            background:
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Link to="/dashboard">
            <MagneticButton>
              <Sparkles className="h-4 w-4" /> Launch StudentOS
            </MagneticButton>
          </Link>
          <MagneticButton variant="ghost">
